...
GreenFractionLast = function(YearlyFolderDir){
  ...
  # For loop over the years
    ...
    imgDayDF$GreenFraction[h] = recIGF
      ...
      ## Export excel tables
      write_xlsx(imgDayDfMean, paste0("C:/Users/markus.israelsen/OneDrive - NINA/GitHub/LierneGreening/LierneGreening/Output/", "dailyGreen_", substring(max(yearFoldersLength), 14, 17), "_", substring(imagePath, 76, 89), ".xlsx"))
  }
}
...
write_xlsx(greenFractionDF, "C:/Users/markus.israelsen/OneDrive - NINA/GitHub/LierneGreening/LierneGreening/Output/RmAfter25June/dailyGreenPixels.xlsx")
...
rl0009.plot = ggplot(data = rl0009, aes(x = YearDay, y = meanGreenFraction, grouop = as.factor(year), color = as.factor(year))) +
    ...
    scale_color_manual(values = c("#ffb25b", "#2dccd3", "#004f71", "#93328E")) + 
    scale_y_continuous(breaks = scales::pretty_breaks(n = 10)) +
    scale_x_continuous(labels = c("Mar", "Apr", "Mai", "Jun", "Jul"))
rl0009.plot
ggsave("C:/Users/markus.israelsen/OneDrive - NINA/GitHub/LierneGreening/LierneGreening/Output/SQ1_2022.png", width=23, height=17, units="cm", dpi=600)
...
rl0017.plot = ggplot(data = rl0017, aes(x = YearDay, y = meanGreenFraction, grouop = as.factor(year), color = as.factor(year))) +
    ...
    scale_x_continuous(labels = c("Mar", "Apr", "Mai", "Jun", "Jul"))
rl0017.plot
ggsave("C:/Users/markus.israelsen/OneDrive - NINA/GitHub/LierneGreening/LierneGreening/Output/SQ2_2022.png", width=23, height=17, units="cm", dpi=600)
...
rl0013.plot = ggplot(data = rl0013, aes(x = YearDay, y = meanGreenFraction, grouop = as.factor(year), color = as.factor(year))) +
    ...
    scale_x_continuous(labels = c("Mar", "Apr", "Mai", "Jun", "Jul"))
rl0013.plot
ggsave("C:/Users/markus.israelsen/OneDrive - NINA/GitHub/LierneGreening/LierneGreening/Output/SQ3_2022.png", width=23, height=17, units="cm", dpi=600)
...
rl0011.plot = ggplot(data = rl0011, aes(x = YearDay, y = meanGreenFraction, grouop = as.factor(year), color = as.factor(year))) +
    ...
    scale_x_continuous(labels = c("Mar", "Apr", "Mai", "Jun", "Jul"))
rl0011.plot
ggsave("C:/Users/markus.israelsen/OneDrive - NINA/GitHub/LierneGreening/LierneGreening/Output/SQ4_2022.png", width=23, height=17, units="cm", dpi=600)
...
rl0015.plot = ggplot(data = rl0015, aes(x = YearDay, y = meanGreenFraction, grouop = as.factor(year), color = as.factor(year))) +
    ...
    scale_x_continuous(labels = c("Mar", "Apr", "Mai", "Jun", "Jul"))
rl0015.plot
ggsave("C:/Users/markus.israelsen/OneDrive - NINA/GitHub/LierneGreening/LierneGreening/Output/SQ5_2022.png", width=23, height=17, units="cm", dpi=600)
...
rl0021.plot
ggsave("C:/Users/markus.israelsen/OneDrive - NINA/GitHub/LierneGreening/LierneGreening/Output/SQ6_2022.png", width=23, height=17, units="cm", dpi=600)
...
rl0019.plot = ggplot(data = rl0019, aes(x = YearDay, y = meanGreenFraction, grouop = as.factor(year), color = as.factor(year))) +
    ...
    scale_x_continuous(labels = c("Mar", "Apr", "Mai", "Jun", "Jul"))
rl0019.plot
ggsave("C:/Users/markus.israelsen/OneDrive - NINA/GitHub/LierneGreening/LierneGreening/Output/SQ7_2022.png", width=23, height=17, units="cm", dpi=600)
...
ggsave("C:/Users/markus.israelsen/OneDrive - NINA/GitHub/LierneGreening/LierneGreening/Output/Mean_SQ1-7_2022.png", width=23, height=17, units="cm", dpi=600)
